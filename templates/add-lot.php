...
<form class="form form--add-lot container <?=$class_name;?>" action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        <?php $class_name = isset($errors['Название']) ? "form--invalid" : "";
        $value = isset($lot['title']) ? $lot['title'] : ""; ?>

        <div class="form__item"> <!-- form__item--invalid -->
            <label for="lot-name">Наименование</label>
            <input class="<?=$class_name;?>" id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?=$value;?>">
    ...
    <div class="form__item form__item--file"> <!-- form__item--uploaded -->
        ...
        <div class="form__input-file">
            <input class="visually-hidden" type="file" id="photo2" name="photo_file" value="">
            <label for="photo2">
                <span>+ Добавить</span>
            </label>
        </div>
